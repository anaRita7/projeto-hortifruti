...
public class ClienteControllerTest {
	...
	public void consultarCliente() {
		ResponseEntity<ClienteDTO> clienteResponse = clienteController.consultarCliente(5);
	...
	public void deleteCliente() {
		ResponseEntity<String> clienteResponse = clienteController.excluirCliente(24);
